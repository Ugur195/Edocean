                    ...
                    <div class="card-body">
                        <div class="tab-content pt-5">
                            ...
                            <div class="tab-pane active" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                                <form id="myAboutUs" action="{{route('admin.about_us.update',$about_us->id)}}"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 text-right col-form-label">Our
                                            Responsibility</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <input name="our_responsib"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 text-right col-form-label">Our
                                            Responsibility_Ru</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <input name="our_responsib_ru"
                                                   class="form-control form-control-lg form-control-solid" type="text"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 text-right col-form-label">Our
                                            Responsibility_En</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <input name="our_responsib_en"
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-xl-3 col-lg-3 text-right col-form-label">Video_Sub_Title</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <input name="video_sub_title"
                                                   class="form-control form-control-lg form-control-solid" type="text"
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-xl-3 col-lg-3 text-right col-form-label">Video_Sub_Title_Ru</label>
                                        <div class="col-lg-9 col-xl-6">
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-xl-3 col-lg-3 text-right col-form-label">Video_Sub_Title_En</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <input name="video_sub_title_en"
                                                   class="form-control form-control-lg form-control-solid" type="text"
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-xl-3 col-lg-3 text-right col-form-label">Our_Purpose_Ru</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <input name="our_purpose_ru"
                                                   class="form-control form-control-lg form-control-solid"
                                                   type="text"
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-xl-3 col-lg-3 text-right col-form-label">Our_Purpose_En</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <input name="our_purpose_en"
                                                   class="form-control form-control-lg form-control-solid"
                                                   type="text"
