                    ...
                    <div class="card-body">
                        <div class="tab-content pt-5">
                            ...
                            <div class="tab-pane active" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                                <form id="MenuEdit" action="{{route('admin.menus.update',$menu_edit->id)}}" class="form"
                                      method="POST">
                                    @method('put')
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <input name="page" class="form-control form-control-lg form-control-solid"
                                                   type="text"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <select name="status"
                                                ...
                                                <option value="1" @if($menu_edit->status==1) selected @endif>Aktiv
                                                </option>
                                                <option value="0" @if($menu_edit->status==0) selected @endif>Deaktiv
                                                </option>
                                            </select>
