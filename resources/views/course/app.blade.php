                        ...
                        <li class="menu-item   @if(Request::url()==url('admin/course/course_students')) menu-item-active @endif ">
                            <a href="{{url('admin/course/course_students')}}" class="menu-link">
                               <span class="svg-icon menu-icon">
                                ...
                                <span class="menu-text">Student Requests</span>
                            </a>
                        </li>


                        <li class="menu-item   @if(Request::url()==url('admin/course/course_teacher')) menu-item-active @endif ">
                            <a href="{{url('admin/course/course_teacher')}}" class="menu-link">
                                <span class="svg-icon menu-icon">
                                       <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                ...
                                <span class="menu-text">Teacher Requests</span>
                            </a>
                        </li>
