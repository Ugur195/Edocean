                    ...
                    <div class="tab-content pt-5">
                        ...
                        <div class="tab-pane active" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                            <form class="form" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 text-right col-form-label">Video Presentation</label>
                                    <div class="col-lg-9 col-xl-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input name="email" class="form-control form-control-lg form-control-solid" type="text"
                                            value="{{$course->email}}"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input name="lesson_cost" class="form-control form-control-lg form-control-solid"
                                            type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input name="dislike" class="form-control form-control-lg form-control-solid"
                                            type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input name="see_count" class="form-control form-control-lg form-control-solid"
                                            type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input name="course_type" class="form-control form-control-lg form-control-solid"
                                            type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input name="language" class="form-control form-control-lg form-control-solid"
                                            type="text"
                                ...
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 text-right col-form-label">Lessons Duration</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input name="lessons_duration" class="form-control form-control-lg form-control-solid"
                                                type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input name="lessons_intensivity" class="form-control form-control-lg form-control-solid"
                                            type="text"
