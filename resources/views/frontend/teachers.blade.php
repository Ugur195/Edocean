                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="teacher-sidebar">
                                <div class="sidebar_img">
                                    <img src="/frontendCss/images/ugur.jpg" alt="" />
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 tchr_about">
                            ...
                            <p>
                                Mən, Məmmədov Kənan Azərbaycan Dövlət Neft və Sənaye
                                Universitetinin 4-cü kurs tələbəsiyəm. 2022-ci ilin mart ayından
                                frontend proqramlaşdırmayla məşğulam. Məşğul olduğum müddət
                                ərzində Html5, Css3, Bootstrap, JavaScript, React Js, Responsive
                                Web design, Jquery texnologiyaları üzrə biliklərə yiyələnmişəm.
                                Hal-hazırda bu texnologiyalar üzrə tədris aparıram.
                            </p>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="about_tchr">
                                ...
                                <div class="about_tchr_row">
                                    <div class="row">
                                        ...
                                        <p class="col-lg-9">Aztelekom</p>
                                    </div>
                                </div>
                                <div class="about_tchr_row">
                                    <div class="row">
                                        <h5 class="col-lg-3">İş təcrübəsi:</h5>
                                        <p class="col-lg-9">1 il</p>
                                    </div>
                                </div>
                                <div class="about_tchr_row">
                                    <div class="row">
                                ...
                                <div class="about_tchr_row">
                                    <div class="row">
                                        ...
                                        <p class="col-lg-9">070-431-43-00</p>
                                    </div>
                                </div>
                                <div class="about_tchr_row">
                                    <div class="row">
                                        <h5 class="col-lg-3">Email:</h5>
                                        <p class="col-lg-9">kananmammadov2002@gmail.com</p>
                                    </div>
                                </div>
                                <div class="about_tchr_row">
                                    <div class="row">
                                        <h5 class="col-lg-3">Cinsi:</h5>
                                        <p class="col-lg-9">Kişi</p>
                                    </div>
                                </div>
                                <div class="about_tchr_row">
                                    <div class="row">
                                        <h5 class="col-lg-3">Ünvan:</h5>
                                        <p class="col-lg-9">Azərbaycan, Bakı</p>
                                    </div>
                                </div>
                            </div>
                        </div>
