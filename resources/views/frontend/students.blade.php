                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 mb-5">
                        ...
                        @if($cat !== null and $sub !== null)
                            <div class="col-lg-6 col-md-6 col-sm-12 blog-card-container">
                                <div class="blog-card">
                                    <img class="blog-card-img" src="data:image/jpeg;base64,{{base64_encode($s->image)}}" alt="">
                                    <div class="details">
                                        ...
                                        <div class="blog-btn">
                                            <p style="margin-right: auto">
                                                ...
                                                <a href="{{ $s->facebook }}" target="_blank" style="padding-left: 10px; padding-right: 10px;">
                                            ...
                                            <a href="{{url('single_student/'.$s->id)}}">
                                                <button>Daha Ətraflı
                            ...
                            @foreach($students as $s)
                                @if($s->created_at !== null)
                                    <div class="recent-post-div d-flex align-items-center">
                                        <img style="object-fit: contain;" class="blog-card-img" src="data:image/jpeg;base64,{{base64_encode($s->image)}}" alt="">
