                                ...
                                <div class="details">
                                    <div class="details-1" style="display: flex; flex-direction:column;">
                                        <div class="name-and-img">
                                            <p style="margin-left: auto; margin-right:auto;">{{$c->name." ".$c->surname}}</p>
                                        </div>
                                    ...
                                    <div class="blog-btn">
                                        <p style="margin-right: auto">
                                            <a href="{{ $c->whatsapp }}" target="_blank">
                                            ...
                                            <a href="{{ $c->facebook }}" target="_blank" style="padding-left: 10px; padding-right: 10px;">
