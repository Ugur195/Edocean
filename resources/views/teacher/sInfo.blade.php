                                ...
                                <form class="form" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="radio-inline">
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="parent"
                                                           @if($student->parent=='Yes') checked
                                                           @endif value="Yes" disabled/>
                                                    <span></span>
                                                    Yes
                                                </label>
                                                <labeL class="radio radio-primary">
                                                    <input type="radio" name="parent"
                                                           @if($student->parent=='No') checked
                                                           @endif value="No" disabled/>
                                                    <span></span>
                                                    No
                                                </labeL>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <input
                                                class="form-control form-control-lg form-control-solid"
                                                type="text"
                                                value="{{\App\Models\SubjectCategory::find($student->subjects_category)->name}}" readonly/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <input
                                                   class="form-control form-control-lg form-control-solid"
                                                   type="text"
                                                   value="{{\App\Models\Subjects::find($student->subjects)->name}}" readonly/>
                                        </div>
                                    </div>
                                            ...
                                            <div class="radio-inline">
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="education_level"
                                                           ...
                                                           @endif value="Elemenentary" disabled/>
                                                    <span></span>
                                                    Elementary
                                                </label>
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="education_level"
                                                           ...
                                                           @endif value="Secondary" disabled/>
                                                    <span></span>
                                                    Secondary
                                                </label>
                                                ...
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="education_level"
                                                           @if($student->education_level=='Higher') checked
                                                           @endif value="Higher" disabled/>
                                                    <span></span>
                                                    Higher
                                                </label>
                                            </div>
                                            ...
                                            <div class="radio-inline">
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="lesson_duration"
                                                           @if($student->lesson_duration=='1 hour') checked
                                                           @endif value="1 hour" disabled/>
                                                    <span></span>
                                                    1 hour
                                                </label>
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="lesson_duration"
                                                           ...
                                                           @endif value="1 hour 30 min" disabled/>
                                                    <span></span>
                                                    1 hour 30 min
                                                </label>
                                            ...
                                            <div class="radio-inline">
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="lessons_intensivity"
                                                           ...
                                                           @endif value="2 times per week" disabled/>
                                                    <span></span>
                                                    2 times per week
                                                </label>
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="lessons_intensivity"
                                                           ...
                                                           @endif value="3 times per week" disabled/>
                                                    <span></span>
                                                    3 times per week
                                                </label>
                                                ...
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="lessons_intensivity"
                                                           ...
                                                           @endif value="5 times per week" disabled/>
                                                    <span></span>
                                                    5 times per week
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <input
                                                   class="form-control form-control-lg form-control-solid"
                                                   type="text"
                                                   value="{{$student->teacher_status}}" readonly/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9 col-form-label">
                                            <div class="radio-inline">
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="teacher_gender" disabled
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9 col-form-label">
                                            <div class="radio-inline">
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="students_amount" disabled
                                                           @if($student->students_amount=='Alone') checked
                                                           @endif value="Alone"/>
                                                    <span></span>
                                                    Alone
                                                </label>
