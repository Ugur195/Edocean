...
class Course extends Model
{
    ...
    protected $fillable = ['id', 'image', 'name', 'video_presentation', 'certificate', 'stf_image', 'mmc', 'address', 'email', 'password', 'phone',
        ...
        'likes', 'dislike', 'see_count','course_type', 'language', 'lessons_duration', 'lessons_intensivity', 'students_amount', 'slug', 'country', 'city', 'user_id', 'verified_status', 'status', 'created_at', '	updated_at'
    ];
}
