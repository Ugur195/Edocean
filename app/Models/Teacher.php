...
class Teacher extends Model
{
    ...
    protected $fillable = ['id', 'image', 'name', 'surname', 'father_name', 'birthday', 'gender', 'email', 'password', 'country',
        ...
        'certificate', 'stf_image', 'work_experience', 'work_place', 'work_position', 'work_date', 'lessons_duration', 'lessons_intensivity',
        'rating', '	balance', 'likes', 'dislike', 'see_count', 'vip', 'premium', 'basic', 'slug', 'verified_status', 'user_id', 'status', 'created_at', 'updated_at'
    ];
}
