...
!(function (t, e) {
    ...
    class Ae extends B {
        ...
        _getMenuElement() {
            return t.next(this._element, ".dropdown-menus")[0];
        }
        _getPlacement() {
        ...
        _selectMenuItem({ key: e, target: i }) {
            const n = t
                .find(
                    ".dropdown-menus .dropdown-item:not(.disabled):not(:disabled)",
                    this._menu
                )
                .filter(c);
                ...
                /input|textarea/i.test(e.target.tagName)
                    ...
                    ("Escape" !== e.key &&
                        (("ArrowDown" !== e.key && "ArrowUp" !== e.key) ||
                            e.target.closest(".dropdown-menus")))
                    : !pe.test(e.key)
            )
                return;
    ...
    class ti extends B {
        ...
        _transitionComplete(e, i, n) {
            if (i) {
                ...
                const e = t.findOne(":scope > .dropdown-menus .active", i.parentNode);
            ...
            if (
                ...
                s && s.classList.contains("dropdown-menus"))
            ) {
